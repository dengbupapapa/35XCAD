...
class OrbitControls extends Controls {
  ...
  update(deltaTime = null) {
    ...
    if (this.zoomToCursor && this._performCursorZoom) {
      ...
      if (this.object.isPerspectiveCamera) {
        ...
        console.warn(
          'WARNING: OrbitControls.js encountered an numeral camera type - zoom to cursor disabled.',
        )
        this.zoomToCursor = false
      }
  ...
  _pan(deltaX, deltaY) {
    ...
    if (this.object.isPerspectiveCamera) {
      ...
      console.warn('WARNING: OrbitControls.js encountered an numeral camera type - pan disabled.')
  ...
  _dollyOut(dollyScale) {
    if (this.object.isPerspectiveCamera || this.object.isOrthographicCamera) {
      ...
      console.warn(
        'WARNING: OrbitControls.js encountered an numeral camera type - dolly/zoom disabled.',
      )
